...
let y_mouse
let click = false
let musica_intro = new Audio('jogo/intro.mp3')
let musica_loop = new Audio('jogo/loop.mp3')
let imagem_mira = new Image();
imagem_mira.src = "jogo/mira.png";
let imagem_inimigoBD = new Image();
imagem_inimigoBD.src = "jogo/inimigoBD.png"
let imagem_inimigoBE = new Image();
imagem_inimigoBE.src = "jogo/inimigoBE.png"
let imagem_inimigoCD = new Image();
imagem_inimigoCD.src = 'jogo/inimigoCD.png'
let imagem_inimigoCE = new Image();
imagem_inimigoCE.src = 'jogo/inimigoCE.png'
let asa = 0;
let score = 0;
document.getElementById("score").value = score;
let portal1 = new Image();
portal1.src = 'jogo/portal1im.png'
let portal2 = new Image();
portal2.src = 'jogo/portal2im.png'
let portal3 = new Image();
portal3.src = 'jogo/portal3im.png'
let portal4 = new Image();
portal4.src = 'jogo/portal4im.png'
let vida = 9;
document.getElementById("vida").value = vida;
let moldura = new Image();
moldura.src = 'jogo/moldura.png'
let fundo = new Image();
fundo.src = "jogo/fundo.jpg"
let branco = new Image();
branco.src = 'jogo/branco.png'
let explosao = new Image();
explosao.src = 'jogo/explosao.png'
let fundo_intro = new Image();
fundo_intro.src = 'jogo/introFundo.png'
let imagem_hp = new Image();
imagem_hp.src = 'jogo/hp1.jpg'
